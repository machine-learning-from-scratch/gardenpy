...
class _Array(ABC):
    ...
    def reset(cls, *args: T | str | None) -> None:
        ...
        # remove arrays
        removed_arrays = [itm for i, itm in enumerate(cls._cache) if i not in arg_ids and itm is not None]
...
class Matrix(_Array):
    ...
    def track_reset(cls, *args: Matrix | str | None) -> None:
        ...
        untracked_arrays = [itm for i, itm in enumerate(cls._cache) if i not in args and itm is not None]
